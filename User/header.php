...
{
	echo '<script type="text/javascript"> alert("Only For Register User Access Area "); </script>';
...
while($rowSesion  =  mysql_fetch_array($resSesion))
{
  ...
  $UserDBPass    	= $rowSesion['Password'];
  
  $MyPhoto        = $rowSesion['photo'];
                        ...
                        <ul class="nav navbar-nav pull-right right-navbar-nav">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle user-menu" data-toggle="dropdown">
									<img src="<?php echo '../'.$MyPhoto;?>" alt="<?php echo '../'.$MyPhoto;?>">
		...
		<div id="main-menu-inner">
			<div class="menu-content top" id="menu-content-demo">
				...
				<div>
					...
					<img src="<?php echo '../'.$MyPhoto;?>" alt="" class="">
					<div class="btn-group">
...
<!--				<li >
				...
				<li class="active">
					<a href="mysnipptes.php"><i class="menu-icon fa fa-tasks"></i><span class="mm-text">My Snipptes</span></a>
				</li>
                <li class="mm-dropdown">
				...
				<li>
					<a href="change_password.php"><i class="menu-icon fa fa-tasks"></i><span class="mm-text">Change Password</span></a>
				</li>
