...
<div class="col-xs-6 bord"> 
    <div class="table-info">
        ...
        <div class="col-xs-12">
            <div class="col-xs-5 btn btn-primary marginright"><a href="community_detail.php?snipid=<?php echo $row['sniptsid'] ;?>">Detail</a></div>
            <div class="col-xs-5 btn btn-success marginright"><a href="favorite.php?snipid=<?php echo $row['sniptsid'] ;?>&userid=<?php echo $UserSessions;?>">Favroit</a></div>
        </div>
      </div>                       
</div> 
<?php } ?>                       
