...
$select ="select * from addsnippts where user = '$UserSessions' order by sniptsid DESC";
$res  =  mysql_query($select);
                    ...
                    if(isset($_POST['SearchForm'])){
			         ...
			         if($searchName != ''){
					 $q = "select * from addsnippts where title like '%$searchName%'
					 order by sniptsid desc";}
...
<div class="col-xs-6 bord"> 
    <div class="table-info">
        ...
        <div class="col-xs-12">
        	<div class="col-xs-5 btn btn-primary marginright"><a href="mysnipptes_detail.php?snipid=<?php echo $row['sniptsid'] ;?>">Detail</a></div>
            <div class="col-xs-3 btn btn-success marginright"><a href="favorite.php?snipid=<?php echo $row['sniptsid'] ;?>&userid=<?php echo $UserSessions;?>">Favroit</a></div>
