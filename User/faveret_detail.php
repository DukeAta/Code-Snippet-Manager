...
<!------------------ Header Close ------------------->
   ...
   <div id="content-wrapper">
		<div class="page-header">
			<h1>My Favorite Snipptes Detail </h1>
		</div> <!-- / .page-header -->
			...
			<div class="col-sm-12">
				...
				<div class="panel">
					<div class="panel-heading">
						<div class="col-xs-6">My Favorite Snipptes Detail</div>
                        <div class="col-xs-4">
...
<div class="col-xs-12 bord2"> 
    <div class="table-info">
        ...
        <div class="col-xs-12 bordbottom"><b>Title:&nbsp;</b><?php echo $SnipTitleShort; ?></div>
        <div class="col-xs-12 bordbottom" id="snipDetails"><pre><?php echo $codefull ?></pre></div>
        <div class="col-xs-12 bordbottom bordnone"></div>
        <div class="col-xs-12">
            <div class="col-xs-3 btn btn-danger marginright"><a onClick="return confirm('Are you sure to delete this record ?');" href="dell.php?id=<?php  echo $FavID;?>">Delete</a></div>        </div>
      </div>                       
</div> 
<!--------End-------->
