...
$select ="select * from addsnippts where user = '$UserSessions' and sniptsid ='$snipDetailID' order by sniptsid DESC";
...
<div class="col-xs-12 bord2"> 
    <div class="table-info">
        ...
        <div class="col-xs-12">
            <div class="col-xs-3 btn btn-success marginright"><a href="mysnipptes_detail_edit.php?id=<?php echo $row['sniptsid'] ;?>&userid=<?php echo $UserSessions;?>">Edit</a></div>
